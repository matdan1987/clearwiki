<?php
// views/404.php - Seite nicht gefunden
...
<head>
    ...
    <title><?= __('page_not_found_title') ?> | ClearWiki</title>
...
<body>
    <div>
        <h1>404</h1>
        <p><?= __('page_not_found_message') ?></p>
        <p><a href="/<?= htmlspecialchars($current_lang ?? DEFAULT_LANG) ?>/"><?= __('back_to_homepage') ?></a></p>
    </div>
</body>
</html>